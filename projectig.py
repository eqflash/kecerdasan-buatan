...
class Bot():
    ...
    comments = [
        'Custom Casenya kakaaaaa', 'Follback kakaaaaa' ,'keren '
    ]

    accounts = [
        'google', 'tiktok', 'googledevs'
    ]

    def __init__(self):
        self.login('benscstutorials')
        self.like_comment_by_hashtag('tiktokindonesia')
    ...
    def login(self, username):
        ...
        username_input.send_keys("Masukan Username")
        password_input = self.driver.find_element_by_xpath("//input[@name='password']")
        password_input.send_keys("Masukan Password")
